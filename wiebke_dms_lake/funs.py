...
# %%
def open_ptr_data():
    path = '/Users/diego/python_packs/wiebke-dms-lake/wiebke_dms_lake/data/DMSoxidationProducts.csv'
...
def get_conc_localtime_array():
    path = '/Users/diego/data_tmp/flexpart_management_data/flexpart_management/tmp_data/new_log_pol_ds_agl.nc'
